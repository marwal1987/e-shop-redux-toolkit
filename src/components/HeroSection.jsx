const HeroSection = () => {
  return (
    <div className="relative max-w-full m-auto border-b-2 border-b-[#3a3f54aa]">
      <div className="w-full h-[800px] bg-gradient-to-br from-stone-800 via-stone-100 via-60% to-stone-800 "></div>
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-white drop-shadow-xl lg:p-36 p-12 gap-12 max-w-full text-center  bg-opacity-50 backdrop-blur-lg">
